...
class DocumentDatabase():
    ...
    def handleBinaryAPICall(self, a, sessionObject=None):
        ...
        if k == libnacl.crypto_generichash(self.syncKey.encode("utf8").ljust(32,b'\0'),tbytes):
            openingKey = self.syncKey
            writePassword=False

        elif k==libnacl.crypto_generichash(self.writePassword.encode("utf8").ljust(32,b'\0'),tbytes):
