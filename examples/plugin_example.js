...
(function()
{
	...
	freeboard.loadDatasourcePlugin({
		...
		{
			// myDatasourcePlugin is defined below.
			newInstanceCallback(new targetPlugin(settings, updateCallback));
		}
	});
	...
	// -------------------
	// Here we implement the actual datasource plugin. We pass in the settings and updateCallback.
	var targetPlugin = function(settings, updateCallback)
	{
		// Always a good idea...
		var self = this;
		...
		function getData()
		{
			var newData = { hello : "test" }; // Just putting some sample data in for fun.
