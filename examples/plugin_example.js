...
(function()
{
	...
	freeboard.loadDatasourcePlugin({
		...
		{
			// myDatasourcePlugin is defined below.
			newInstanceCallback(new myTargetPlugin(settings, updateCallback));
		}
	});
	...
	// -------------------
	// Here we implement the actual datasource plugin. We pass in the settings and updateCallback.
	var myTargetPlugin = function(settings, updateCallback)
	{
		// Always a good idea...
		var self = this;
        ...
        self.proxy =  new Proxy(self.data, handler)
