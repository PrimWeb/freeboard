...
var Sparticles = (function () {
    ...
    Sparticle.prototype.render = function (canvasses) {
      ...
      if (!(this.shape== "image"||this.shape === "colorimage")) {
    ...
    Sparticles.prototype.setupOffscreenCanvasses = function (callback) {
      ...
      colors.forEach(function (color) {
        ...
        shapes.forEach(function (shape) {
          ...
          if (shape === "image" || shape === "colorimage") {
            imageUrls.forEach(function (imageUrl, i) {
              ...
              image.onload = function () {
                ...
                _this3.drawOffscreenCanvasForImage(image, color, imageCanvas,(shape === "colorimage"));
    ...
    Sparticles.prototype.drawOffscreenCanvasForImage = function (image, color, canvas,fullColor) {
